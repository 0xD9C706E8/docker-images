...
| [openchamber](images/openchamber/) | [openchamber/openchamber](https://github.com/openchamber/openchamber) | node (debian) | amd64, arm64 | OpenChamber web UI; connects to an external OpenCode server via OPENCODE_HOST | MIT |
| [opencode](images/opencode/) | [anomalyco/opencode](https://github.com/anomalyco/opencode) | node (debian) | amd64, arm64 | OpenCode agent runtime with aqua-managed CLI toolchain and remote BuildKit client | MIT |
